...
gen delta= 0.17083326
replace delta= 0.23740564  if Industry==2
replace delta= 0.4520725 if Industry==3
replace delta= 0.41210619 if Industry==4
replace delta= 0.73147772 if Industry==5

gen gamma=0.24389086 
replace gamma= 0.26944584 if Industry==2
replace gamma= 0.17510481 if Industry==3
replace gamma= 0.10092007  if Industry==4
replace gamma= 0.22885141  if Industry==5
...
collapse (mean) Adj_q q, by(fyear)
